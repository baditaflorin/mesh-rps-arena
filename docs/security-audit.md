# Security audit — mesh-rps-arena

Generated: **2026-05-17T13:29:12.680Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "e3b5faf5ae7280c236837c9f0d2662c841689be469e07c4a87182e26decc001f",
  "pubkeyB": "e3b5faf5ae7280c236837c9f0d2662c841689be469e07c4a87182e26decc001f"
}
```
...
```json
{
  "pubkeyA": "a801f0356fd1bab2",
  "pubkeyB": "20d8b2c9cf6ed5bb"
}
```
...
```json
{
  "plantedExpiresAt": 1779024492672,
  "now": 1779024552675
}
```
...
```json
{
  "realPubkey": "800ed9a6c5dbd6d1",
  "forgerPubkey": "d2ac01ced775c084"
}
```
...
```json
{
  "forgedPubkey": "528555e288d50d4c",
  "realPubkey": "82fff67a4fec2ecc"
}
```
